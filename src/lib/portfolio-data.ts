export const resumeData = {
  ...
  experience: [
    {
      ...
      company: "Empover I-Tech",
      type: "Onsite",
      period: "OCT 2025 \u2013 Current",
      bullets: [
        "Architected an end-to-end ETL automation suite and data orchestration pipeline using Python and Agentic AI, reducing manual processing by 80% with 99.9% data integrity.",
        "Implemented a multilingual RAG framework using LangChain, FAISS, and local LLMs, while deploying optimized Flask backend APIs for real-time systems.",
      ],
    },
    {
  ...
  projects: [
    ...
    {
      title: "Mobile UI Element Detection",
      description:
  ...
  achievements: [
    {
      title: "College ML Hackathon",
      description:
        "Secured 2nd position for engineering a high-performance machine learning solution.",
      award: "2nd Place",
    },
    {
      title: "Cisco Sustainability Hackathon",
      description:
        "Secured 5th place nationally for presenting an AI-driven sustainability prototype.",
      award: "5th Place National",
    },
  ],
};
